const Footer = () => {
    return (
        ...
        <footer
            ...
            className="flex flex-col items-center bg-zinc-50 text-center text-surface dark:bg-[#0b1727] dark:text-white">
                    ...
                    <form action="">
                        <div
                            ...
                            <div className="mb-6 md:me-auto">
                                <button
                                    type="submit"
                                    className="inline-block border border-blue-600 text-blue-600 hover:bg-blue-600
                                    hover:text-white py-1.5 px-4 rounded"
